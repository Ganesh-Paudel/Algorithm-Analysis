...
class PathfindingAnimation(mnim.Scene):
    ...
    def mark_start_goal(self) -> None:
        ...
        start_circle = Circle(
            radius=self.cell_size * 0.4, color=GREEN, fill_opacity=0.7
        )
        ...
        print(
            f"Start: {self.data.start_node} (green), Goal: {self.data.goal_node} (red)"
        )
    ...
    def construct(self):
        ...
        animation_files = ["results/animation_data/genetic_algo_example.json"]
